...
export default function SignUp() {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
       await axios.post("http://localhost:8082/auth/register", state);
       navigate("/login");
     };
    return (
                                             ...
                                             <div className="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div className="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="form3Example2c" className="form-control" />
                                            ...
                                            <div className="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div className="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="password"
                                                        ...
                                                        id="form3Example5c" className="form-control" />

                                                </div>
                                            </div>

                                            <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                                <button type="button" className="btn btn-primary btn-lg" onClick={onSubmit} >Register</button> &nbsp; 
                                                <Link type="button" className="btn btn-primary btn-lg" to="/login">Login</Link>
                                            </div>
                                        </form>
                                    </div>
